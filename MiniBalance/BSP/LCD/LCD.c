...
#include "stm32f10x.h"
#include "./lcd/LCD.h"
#include "./lcd/GB1616.h"	//16*16汉字字模
#include "./lcd/asc8x16.h"
/*
 * 函数名：LCD_GPIO_Config
 * 描述  ：根据FSMC配置LCD的I/O
 * 输入  ：无
...
void LCD_GPIO_Config(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12;	         	//LCD CS
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;   		// 
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_10MHz;
	GPIO_Init(GPIOB, &GPIO_InitStructure);		        	//B端口 
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;	         	//LCD RS
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;   		// 
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_10MHz;
