...
void lcd_show(void)
{
	//=============第一行显示小车模式=======================//	
	//if(Way_Angle==1)	
	//	LCD_P8x16Str(0,0,"DMP",WHITE,BLACK,0);//OLED_ShowString(0,0,"DMP");
	//else if(Way_Angle==2)	
	//	LCD_P8x16Str(0,0,"Kalman",WHITE,BLACK,0);//OLED_ShowString(0,0,"Kalman");
	//else if(Way_Angle==3)	
	//	LCD_P8x16Str(0,0,"Hubu",WHITE,BLACK,0);//OLED_ShowString(0,0,"Hubu");
	//if(Bi_zhang==1)	
	//	LCD_P8x16Str(0,0,"Bizhang",WHITE,BLACK,0);//OLED_ShowString(60,0,"Bizhang");
	//else             
	//	LCD_P8x16Str(0,0,"Putong",WHITE,BLACK,0);//OLED_ShowString(60,0,"Putong");
	//=============第二行显示温度和距离===============//	
	LCD_Printint(80,120 + 0, Voltage, WHITE, YELLOW, 0);
	LCD_Printint(80,120 +16, Encoder_Left, WHITE, YELLOW, 0);
	LCD_Printint(80,120 +32, Encoder_Right, WHITE, YELLOW, 0);
	LCD_Printint(320,120 + 0, Distance, WHITE, YELLOW, 0);
	LCD_Printint(320,120 +16, Angle_Balance, WHITE, YELLOW, 0);
	LCD_Printint(320,120 +32, Temperature, WHITE, YELLOW, 0);			
	//LCD_Printint(80,120 +48, angleResult[1], WHITE, YELLOW, 0);
	...
	//OLED_ShowString(00,20,"EncoLEFT");
	//if( Encoder_Left<0)		
	//	LCD_P8x16Str(80,20,"-",WHITE,BLACK,0);
	//OLED_ShowNumber(95,20,-Encoder_Left,3,12);
	//else                 	
	//	LCD_P8x16Str(80,20,"+",WHITE,BLACK,0);
	//OLED_ShowNumber(95,20, Encoder_Left,3,12);
	...
	//OLED_ShowString(00,30,"EncoRIGHT");
	//if(Encoder_Right<0)		
	//	LCD_P8x16Str(80,30,"-",WHITE,BLACK,0);
	//OLED_ShowNumber(95,30,-Encoder_Right,3,12);
	//else   
	//	LCD_P8x16Str(80,30,"+",WHITE,BLACK,0);            		
	//OLED_ShowNumber(95,30,Encoder_Right,3,12);	
	...
	//OLED_ShowNumber(68,40,Voltage%100,2,12);
	//if(Voltage%100<10) 	
	//LCD_Printint(100, 100 + 16, Voltage, WHITE, BLACK, 0);
		//OLED_ShowNumber(62,40,0,2,12);
	//=============第六行显示角度=======================//
	//OLED_ShowString(0,50,"Angle");
	//if(Angle_Balance<0)		
...
{    
	...
	printk("Z%d:%d:%d:%dL$",(u8)app_2,(u8)app_3,(u8)app_4,(int)Angle_Balance);//打印到APP上面
}
/**************************************************************************
