...
static uint8_t IsKeyUser1Down(void) {if ((GPIO_PORT_KEYUSER1->IDR & GPIO_PIN_KEYUSER1) == 0) return 1;else return 0;}
static uint8_t IsKeyUser2Down(void) {if ((GPIO_PORT_KEYUSER2->IDR & GPIO_PIN_KEYUSER2) == 0) return 1;else return 0;}
...
static void bsp_InitKeyHard(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_PIN_KEYUSER1;
	GPIO_Init(GPIO_PORT_KEYUSER1, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_Pin = GPIO_PIN_KEYUSER2;
	GPIO_Init(GPIO_PORT_KEYUSER2, &GPIO_InitStructure);
